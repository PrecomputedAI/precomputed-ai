...
The diagram is authored in [`diagram.mmd`](./diagram.mmd) (Mermaid). The committed [`diagram.png`](./diagram.png) is kept for manual use and should be regenerated manually from the `.mmd` file only when needed. Don't hand-edit the PNG.
